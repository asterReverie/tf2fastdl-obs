...
public void OnPluginStart()
{
    ...
    g_SoundStart = CreateConVar("sm_vmstart", "clande/votestart.wav", "Path of map vote START sound. Don't include Sound folder in the path");
    g_SoundEnd = CreateConVar("sm_vmstop", "clande/votesuccess.wav", "Path of map vote END sound. Don't include Sound folder in the path");
    //g_SoundFailure = CreateConVar("sm_vmfail", "clande/votesuccess.wav", "Path of map vote FAILURE sound. Don't include Sound folder in the path");
